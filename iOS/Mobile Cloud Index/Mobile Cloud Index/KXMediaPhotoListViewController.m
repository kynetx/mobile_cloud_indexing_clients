//
//  KXMediaPhotoListViewController.m
//  Mobile Cloud Index
//
...
@interface KXMediaPhotoListViewController ()
...
@implementation KXMediaPhotoListViewController
...
{
    return [NSPredicate predicateWithFormat:@"%K == %@ AND %K == %@", @"type", MEDIA_TYPE_STRING_PHOTO, @"fromDevice", [NSNumber numberWithBool:YES]];
}
...
//    thumbnailView.backgroundColor = [UIColor redColor];
    ...
    {
        thumbnailView.image = [UIImage imageNamed:@"42-photos.png"];
    }
