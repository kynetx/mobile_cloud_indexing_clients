//
//  KXMediaPlayListViewController.m
//  Mobile Cloud Index
//
...
@interface KXMediaPlayListViewController ()
...
@implementation KXMediaPlayListViewController
...
{
    return [NSPredicate predicateWithFormat:@"%K == %@", @"playQueue", [NSNumber numberWithBool:YES]];
}
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        thumbnailView.image = [UIImage imageNamed:@"33-cabinet.png"];
    }
