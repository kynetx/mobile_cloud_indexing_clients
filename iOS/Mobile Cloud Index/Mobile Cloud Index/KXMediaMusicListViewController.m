//
//  KXMediaMusicListViewController.m
//  Mobile Cloud Index
//
...
@interface KXMediaMusicListViewController ()
...
@implementation KXMediaMusicListViewController
...
{
    return [NSPredicate predicateWithFormat:@"%K == %@ AND %K == %@", @"type", MEDIA_TYPE_STRING_MUSIC, @"fromDevice", [NSNumber numberWithBool:YES]];
}
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        thumbnailView.image = [UIImage imageNamed:@"65-note.png"];
    }
