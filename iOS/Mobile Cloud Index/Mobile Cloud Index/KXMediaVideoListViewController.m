//
//  KXMediaVideoListViewController.m
//  Mobile Cloud Index
//
...
@interface KXMediaVideoListViewController ()
...
@implementation KXMediaVideoListViewController
...
{
    return [NSPredicate predicateWithFormat:@"%K == %@ AND %K == %@", @"type", MEDIA_TYPE_STRING_VIDEO, @"fromDevice", [NSNumber numberWithBool:YES]];
}
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        thumbnailView.image = [UIImage imageNamed:@"46-movie-2.png"];
    }
